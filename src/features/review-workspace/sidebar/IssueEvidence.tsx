  ...
  return (
    <div className="space-y-3.5">
        ...
        <ul className="space-y-1.5">
          {evidenceList.map((item, idx) => (
            <li key={idx} className="flex gap-2 text-xs text-slate-300 leading-relaxed font-normal">
              <span className="text-indigo-400 font-mono font-bold mt-0.5 select-none text-[10px]">[E{idx + 1}]</span>
              <p>{item}</p>
            </li>
          ))}
        </ul>
      ...
      <div className="p-3 bg-indigo-500/5 rounded-xl border border-indigo-500/10 space-y-1">
        <div className="flex items-center gap-1.5 text-[9px] font-mono font-bold text-indigo-300 uppercase tracking-wider">
      ...
      <div className="p-3 bg-amber-500/5 rounded-xl border border-amber-500/10 space-y-1">
        <div className="flex items-center gap-1.5 text-[9px] font-mono font-bold text-amber-300 uppercase tracking-wider">
